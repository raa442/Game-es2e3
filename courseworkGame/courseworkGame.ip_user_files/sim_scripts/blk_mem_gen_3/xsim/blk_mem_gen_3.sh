...
#
# Generated by Vivado on Sun Dec 04 22:27:59 +0000 2022
...
xv_boost_lib_path=D:/applications/programming/hdlfpga/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax"
...
simulate()
{
  xsim blk_mem_gen_3 -key {Behavioral:sim_2:Functional:blk_mem_gen_3} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/applications/programming/hdlfpga/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
